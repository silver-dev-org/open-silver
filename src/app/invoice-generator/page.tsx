...
import { formSchema, invoiceItemSchema, type FormData, type InvoiceItem } from "./schemas";
...
export default function Component() {
  ...
  const form = useForm<FormData>({
    ...
    defaultValues: {
      ...
      accountNumber: "",
      routingNumber: "",
      billingName: "Silver Dev Recruiting LLC",
      billingAddress: "8 The Green, Dover, DE, 19901, United States",
      items: [],
