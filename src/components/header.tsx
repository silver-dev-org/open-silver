...
export default function Header({
  ...
  heroLinks?: { href: string; label: string }[];
}) {
  const [isMenuOpen, setIsMenuOpen] = useState(false);

  return (
    <header className="fixed top-0 z-50 w-screen bg-background/85 border-b border-accent backdrop-blur-sm p-4">
      <div className="container flex flex-col xl:flex-row justify-between items-center mx-auto">
        <div className="flex items-center justify-between w-full xl:w-auto">
          <h1>
            ...
            <Link onClick={() => setIsMenuOpen(false)} href="/">
              <svg
                className="fill-foreground w-48 hover:opacity-75 trasnition-all duration-300"
                aria-label="Silver.dev"
                role="img"
                viewBox="100 105 796 150"
              >
                <path d="m167.73 244.79-67.12-27.25v10.29l67.12 27.25z" />
                <path d="m170.4 244.43v10.3l107.67-107.16v-10.41z" />
                <path d="m236.44 173.68-47.78-47.59-2.83 2.82 48.45 48.27 43.79-43.63-68.76-28.03-18.3 18.23z" />
                <path d="m209.58 201.78 13.11-13.05-48.45-48.27-13.11 13.05z" />
                <path d="m139.53 180.92 45.5 45.33 5.22-5.21-48.45-48.27-41.19 41.04 68.76 28.04 13.43-13.38z" />
                ...
                <path d="m406.59 136.47c0 1.23-.25 2.37-.74 3.43s-1.15 2-1.98 2.83-1.79 1.47-2.9 1.94-2.27.71-3.5.71-2.37-.24-3.43-.71-1.99-1.12-2.79-1.94-1.44-1.77-1.91-2.83-.71-2.2-.71-3.43.24-2.39.71-3.5 1.11-2.07 1.91-2.9c.8-.82 1.73-1.47 2.79-1.94s2.2-.71 3.43-.71 2.39.24 3.5.71 2.07 1.12 2.9 1.94c.82.82 1.48 1.79 1.98 2.9.49 1.11.74 2.27.74 3.5zm-2.69 22.48v71.59h-12.58v-71.59z" />
                <path d="m437.54 126.44v104.09h-12.58v-104.09z" />
                <path d="m519.23 158.95-29.19 71.59h-11.31l-29.19-71.59h10.25c1.04 0 1.88.26 2.54.78s1.11 1.13 1.34 1.84l18.16 46.08c.57 1.74 1.06 3.44 1.48 5.09s.82 3.3 1.2 4.95c.38-1.65.78-3.3 1.2-4.95s.94-3.34 1.55-5.09l18.37-46.08c.28-.75.75-1.38 1.41-1.87s1.44-.74 2.33-.74h9.82z" />
                ...
                <path d="m896.24 158.95-29.19 71.59h-11.31l-29.19-71.59h10.25c1.04 0 1.88.26 2.54.78s1.11 1.13 1.34 1.84l18.16 46.08c.57 1.74 1.06 3.44 1.48 5.09s.82 3.3 1.2 4.95c.38-1.65.78-3.3 1.2-4.95s.94-3.34 1.55-5.09l18.37-46.08c.28-.75.75-1.38 1.41-1.87s1.44-.74 2.33-.74h9.82z" />
              </svg>
            </Link>
          </h1>
          <Button
        ...
        <div
          className={`flex-col xl:flex-row uppercase my-4 justify-center w-full xl:w-auto transition-all duration-300 ease-in-out ${
            isMenuOpen
              ? "flex max-h-screen"
              : "hidden xl:flex max-h-0 xl:max-h-screen"
          }`}
        >
